            ...
            <Fragment>
                ...
                <Row className='mx-0 mb-4'>
                            ...
                            return (
                                <Col className="col-3 mt-1" key={x}>
                                    <Card className='img_card shadow rounded'>
                                        <div>
                                            <img className="top_images p-2" src={`https://nailsa2z.com:5027/files/${item.cat_id.cat_image}`} loading="lazy" alt="Card" />
                                        </div>

                                        < CardText className="card_text">{item.cat_id.cat_name}</CardText>
                                    </Card>
                                </Col>
                            )
                        })
                    ...
                    <Col className="col-12 text-center mt-3">
                        ...
                        >{all ? 'LESS PRODUCT' : 'ALL PRODUCT'}</Button>
                    </Col>
